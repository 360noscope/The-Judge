...
<head>
    ...
    <title>The Judge: <?php echo $exercise_result["exercise_name"]; ?></title>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-block">
                                ...
                                <p class="card-text"><?php echo $exercise_result["exercise_detail"]; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-block">
                                ...
                                <p class="card-text"><?php echo $exercise_result["exercise_hint"]; ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-block">
                                ...
                                <p class="card-text"><span class="badge badge-danger">Execution Time</span> 
                                <?php echo $exercise_result["time_limit"]; ?> Sec</p>
                                <p class="card-text"><span class="badge badge-success">Memory</span> 
